document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        uk: {
            ...
            description: "LuxBeauty Studio ми пропонуємо професійне італійське нарощування волосся, яке додасть об’єму та довжини вашим локонам. Ми використовуємо лише високоякісні матеріали, забезпечуючи чудовий результат.",
            extratext: "Також у нас ви можете придбати преміальне натуральне волосся.",
        ...
        fr: {
            ...
            description: "LuxBeauty Studio propose des extensions de cheveux italiennes professionnelles qui ajouteront du volume et de la longueur à vos mèches.",
            extratext: " Vous pouvez également acheter des cheveux naturels de qualité supérieure chez nous.",
            ...
            service3: "LuxBeauty Studio propose des extensions de cheveux italiennes professionnelles qui ajouteront du volume et de la longueur à vos mèches. Nous utilisons uniquement des matériaux de haute qualité, garantissant un excellent résultat.",
        ...
        en: {
            ...
            description: "LuxBeauty Studio offers professional Italian hair extensions that will add volume and length to your locks. We use only high-quality materials, ensuring an excellent result.",
            extratext: "You can also purchase premium natural hair from us.",
            ...
            service3: "LuxBeauty Studio offers professional Italian hair extensions that will add volume and length to your locks. We use only high-quality materials, ensuring an excellent result.",
